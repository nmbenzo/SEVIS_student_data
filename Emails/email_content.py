...
isss = ['mjdeproto@usfca.edu', 'ylai9@usfca.edu', 'nbenzschawel@usfca.edu',
        'nlopes@usfca.edu', 'emthompson2@usfca.edu','msmcdermott2@usfca.edu']

test_list = ['nmbenzo@gmail.com', 'nbenzschawel@usfca.edu',
              'nmbenzo@icloud.com']